	...
	namespace orm {
		...
		public:
			...
			builder& field(const std::string& name, const db_integer_type T::*ptr, std::initializer_list<std::function<void(class_info&, field_info&)>> attributes = {}) {
				return field(
					name, db_type::integer, [ptr](entity* e, const db_value& v) { *const_cast<db_integer_type*>(&(static_cast<T*>(e)->*ptr)) = std::get<db_integer_type>(v); }, [ptr](const entity* e) -> db_value { return db_value{static_cast<db_integer_type>(static_cast<const T*>(e)->*ptr)}; }, attributes);
			}
			...
			field(const std::string& name, U T::*ptr, std::initializer_list<std::function<void(class_info&, field_info&)>> attributes = {}) {
				return field(
					name, db_type::integer, [ptr](entity* e, const db_value& v) { static_cast<T*>(e)->*ptr = static_cast<U>(std::get<db_integer_type>(v)); }, [ptr](const entity* e) -> db_value { return db_value{static_cast<db_integer_type>(static_cast<const T*>(e)->*ptr)}; }, attributes);
			}
			...
			builder& field(const std::string& name, U T::*ptr, std::initializer_list<std::function<void(class_info&, field_info&)>> attributes = {}) {
				return field(
					name, db_type::integer, [ptr](entity* e, const db_value& v) { static_cast<T*>(e)->*ptr = std::chrono::system_clock::from_time_t(std::get<db_integer_type>(v)); }, [ptr](const entity* e) -> db_value { return db_value{static_cast<db_integer_type>(std::chrono::system_clock::to_time_t(static_cast<const T*>(e)->*ptr))}; }, attributes);
			}
			template <typename U, typename std::enable_if<std::is_convertible<U, db_text_type>::value>::type* = nullptr>
			builder& field(const std::string& name, U T::*ptr, std::initializer_list<std::function<void(class_info&, field_info&)>> attributes = {}) {
				return field(
					name, db_type::text, [ptr](entity* e, const db_value& v) { static_cast<T*>(e)->*ptr = std::get<db_text_type>(v); }, [ptr](const entity* e) -> db_value { return db_value{static_cast<db_text_type>(static_cast<const T*>(e)->*ptr)}; }, attributes);
			}
			...
			builder& field(const std::string& name, U T::*ptr, std::initializer_list<std::function<void(class_info&, field_info&)>> attributes = {}) {
				return field(
					name, db_type::real, [ptr](entity* e, const db_value& v) { static_cast<T*>(e)->*ptr = std::get<db_real_type>(v); }, [ptr](const entity* e) -> db_value { return db_value{static_cast<db_real_type>(static_cast<const T*>(e)->*ptr)}; }, attributes);
			}
			template <typename U, typename std::enable_if<std::is_convertible<U, db_blob_type>::value>::type* = nullptr>
			builder& field(const std::string& name, U T::*ptr, std::initializer_list<std::function<void(class_info&, field_info&)>> attributes = {}) {
				return field(
					name, db_type::blob, [ptr](entity* e, const db_value& v) { static_cast<T*>(e)->*ptr = std::get<db_blob_type>(v); }, [ptr](const entity* e) -> db_value { return db_value{static_cast<db_blob_type>(static_cast<const T*>(e)->*ptr)}; }, attributes);
			}
			...
			field(const std::string& name, std::optional<U> T::*ptr, std::initializer_list<std::function<void(class_info&, field_info&)>> attributes = {}) {
				return field(
                    ...
                    return db_value{db_null_type{}}; }, {[attributes](class_info& ci, field_info& fi) { fi.nullable = true; for(auto& e : attributes) e(ci, fi); }});
			}
			template <typename U, typename std::enable_if<!std::is_enum<U>::value && std::is_convertible<U, db_integer_type>::value && !std::is_floating_point<U>::value>::type* = nullptr>
			...
			builder& field(const std::string& name, std::array<U, Size> T::*ptr, size_t index, std::initializer_list<std::function<void(class_info&, field_info&)>> attributes = {}) {
				return field(
					name, db_type::integer, [ptr, index](entity* e, const db_value& v) { (static_cast<T*>(e)->*ptr)[index] = std::get<db_integer_type>(v); }, [ptr, index](const entity* e) -> db_value { return db_value{static_cast<db_integer_type>((static_cast<const T*>(e)->*ptr)[index])}; }, attributes);
			}
			// Special overload for time values
			...
			builder& field(const std::string& name, std::array<U, Size> T::*ptr, size_t index, std::initializer_list<std::function<void(class_info&, field_info&)>> attributes = {}) {
				return field(
					name, db_type::integer, [ptr, index](entity* e, const db_value& v) { (static_cast<T*>(e)->*ptr)[index] = std::chrono::system_clock::from_time_t(std::get<db_integer_type>(v)); }, [ptr, index](const entity* e) -> db_value { return db_value{static_cast<db_integer_type>(std::chrono::system_clock::to_time_t((static_cast<const T*>(e)->*ptr)[index]))}; }, attributes);
			}
			template <typename U, size_t Size, typename std::enable_if<std::is_convertible<U, db_text_type>::value>::type* = nullptr>
			builder& field(const std::string& name, std::array<U, Size> T::*ptr, size_t index, std::initializer_list<std::function<void(class_info&, field_info&)>> attributes = {}) {
				return field(
					name, db_type::text, [ptr, index](entity* e, const db_value& v) { (static_cast<T*>(e)->*ptr)[index] = std::get<db_text_type>(v); }, [ptr, index](const entity* e) -> db_value { return db_value{static_cast<db_text_type>((static_cast<const T*>(e)->*ptr)[index])}; }, attributes);
			}
			...
			builder& field(const std::string& name, std::array<U, Size> T::*ptr, size_t index, std::initializer_list<std::function<void(class_info&, field_info&)>> attributes = {}) {
				return field(
					name, db_type::real, [ptr, index](entity* e, const db_value& v) { (static_cast<T*>(e)->*ptr)[index] = std::get<db_real_type>(v); }, [ptr, index](const entity* e) -> db_value { return db_value{static_cast<db_real_type>((static_cast<const T*>(e)->*ptr)[index])}; }, attributes);
			}
			template <typename U, size_t Size, typename std::enable_if<std::is_convertible<U, db_blob_type>::value>::type* = nullptr>
			builder& field(const std::string& name, std::array<U, Size> T::*ptr, size_t index, std::initializer_list<std::function<void(class_info&, field_info&)>> attributes = {}) {
				return field(
					name, db_type::blob, [ptr, index](entity* e, const db_value& v) { (static_cast<T*>(e)->*ptr)[index] = std::get<db_blob_type>(v); }, [ptr, index](const entity* e) -> db_value { return db_value{static_cast<db_blob_type>((static_cast<const T*>(e)->*ptr)[index])}; }, attributes);
			}

			template <typename U, size_t Size, typename std::enable_if<std::is_convertible<U, db_integer_type>::value || std::is_convertible<U, db_text_type>::value || std::is_convertible<U, db_real_type>::value || std::is_convertible<U, db_blob_type>::value || std::is_same<U, std::chrono::system_clock::time_point>::value>::type* = nullptr>
